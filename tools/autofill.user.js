...
(function () {
  ...
  const ME = {
    ...
    // Common screening questions — tune to your situation.
    workAuthorized: "Yes",
  ...
  const RULES = [
    ...
    [/notice period|availability to start|when can you start/, ME.noticePeriod],
    [/expected (salary|compensation|ctc)|salary expectation|desired salary/, ME.expectedSalary],
    [/how did you hear|referral source|source/, ME.howHeard],
    [/city/, ME.city],
    ...
    [/require.*(sponsor|visa)|need.*sponsor|sponsorship/, ME.requireSponsorship],
