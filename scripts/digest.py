...
KEYWORDS = [
    ("ai trainer", 10), ("ai trainer specialist", 10), ("ai training specialist", 10),
    ("llm trainer", 10), ("ai specialist", 9), ("ai tutor", 9), ("ai teacher", 8),
    ("ai coach", 8), ("model trainer", 9), ("generative ai trainer", 10), ("ai/llm", 9),
    ("ai/llm practice", 10), ("ai analyst", 8), ("ai quality", 8),
    ("ai quality specialist", 9), ("ai qa", 8), ("ai evaluator", 9), ("llm evaluation", 9),
    ("model evaluation", 8), ("rlhf", 9), ("reinforcement learning from human feedback", 9),
    ("prompt engineer", 8), ("prompt writing", 7), ("prompt", 4), ("ai content", 6),
    ("human feedback", 7), ("human in the loop", 6), ("human-in-the-loop", 6),
    ("model output", 7), ("fine-tuning", 6), ("fine tuning", 6),
    ("supervised fine-tuning", 7), ("large language model", 6), ("generative ai", 5),
    ("search evaluator", 6), ("search quality", 5), ("ai rater", 6),
    ("conversation design", 5), ("red team", 5), ("ai safety", 5),
    ("machine learning", 3), ("natural language", 3), ("nlp", 3),
]
NEGATIVE_TITLE = [
